...
public class Persoana implements IPersoana{
	...
	public String getSex(){
		switch(CNP.charAt(0)){
			...
			case '5': return "M";
			case '6': return "F";
			case '9':throw new MyException("NU este un CNP valid");
			case '0':throw new MyException("NU este un CNP valid");
	...
	public int getVarsta(){
		...
		if(dataNasterii.after(dataCurenta)) {
			throw new MyException("Persoana nu a fost nascuta inca");
		}
